...
//				float lengthIn=Float.parseFloat(lengthField.getText());
				
				DVD dvd=new DVD(titleIn, categoryIn, directorIn,  lengthIn, costIn);
				
								
				st.addMedia(dvd);
				String message;
				message="Add Media: '"+dvd.getTitle()+"' successfuly ";
